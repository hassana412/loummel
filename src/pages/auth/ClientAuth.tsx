...
import { Loader2, LogIn, UserPlus, ShoppingBag, ArrowLeft, Mail, KeyRound } from "lucide-react";
import { z } from "zod";
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4">
        <Card className="w-full max-w-md shadow-sahel-card">
          <CardHeader className="text-center">
            ...
            <CardTitle className="font-display text-2xl">Espace Client</CardTitle>
            <CardDescription>
              Connectez-vous ou créez un compte pour acheter sur Loummel
            </CardDescription>
          </CardHeader>
          <CardContent>
            <GoogleAuthButton 
